<?php
namespace TextBlock\Site\BlockLayout;
 ...
 */
class TextBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Text only'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/text-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/text-block', [
        'block' => $block,
